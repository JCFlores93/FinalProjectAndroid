...
public class TaskDeleteCase extends UseCase<Tasks> {

    private final TasksRepository tasksRepository;
    private Tasks tasks;
    private String user_token;
    public TaskDeleteCase(TasksRepository tasksRepository,
    ...
    protected void buildUseCase() {
        ...
        this.tasksRepository.deleteTask(this.user_token, this.tasks, new RepositoryCallback<Tasks>() {
            @Override
