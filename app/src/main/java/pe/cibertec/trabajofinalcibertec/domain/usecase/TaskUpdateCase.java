...
public class TaskUpdateCase extends UseCase<Tasks>{

    private final TasksRepository tasksRepository;
    private Tasks tasks;
    private String user_token;

    public TaskUpdateCase(
    ...
    protected void buildUseCase() {
        this.tasksRepository.updateTask(this.user_token, this.tasks, new RepositoryCallback<Tasks>() {
            @Override
